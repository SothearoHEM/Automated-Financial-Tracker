...
function SpendingbyCategoryUSD() {
    const { categoryChartDataUSD } = useContext(FinanceContext);
    ...
    return (
        <div className="bg-white rounded-xl p-6 border border-gray-200 w-full shadow-sm">
            <h3 className="font-semibold text-gray-900 mb-6 text-lg">Spending by Category (USD)</h3>
            <div className="w-full h-75">
                <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                        <Pie
                            data={categoryChartDataUSD}
                            cx="50%"
                            cy="50%"
                            labelLine={false}
                            ...
                            dataKey="value"
                        >
                            {categoryChartDataUSD.map((entry, index) => (
...
export default SpendingbyCategoryUSD;